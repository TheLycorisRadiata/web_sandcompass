...
router.post('/:lang/:id_product/:id_token/:id_account', controller_product.create_product);
...
router.get('/:lang/highlight/display/:id_product', controller_product.retrieve_highlighted_product_for_display);
