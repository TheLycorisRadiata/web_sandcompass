...
const PageNotFound = () =>
{
    ...
    document.title = title_page_not_found(ct.lang) + ' | Mofumofu';
    document.querySelector('meta[name="description"]').setAttribute('content', msg_page_not_found(ct.lang));
    // Open Graph meta tags
    document.querySelector('meta[property="og:title"]').setAttribute('content', title_page_not_found(ct.lang) + ' | Mofumofu');
